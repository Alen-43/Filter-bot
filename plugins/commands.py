...
async def delete_all_index(bot, message):
    await message.reply_text(
        '**ᴛʜɪs ᴘʀᴏᴄᴇss ᴡɪʟʟ ᴅᴇʟᴇᴛᴇ ʏᴏᴜʀ ɪɴᴅᴇxᴇᴅ ғɪʟᴇs ғʀᴏᴍ ʏᴏᴜʀ ᴅᴀᴛᴀʙᴀsᴇ. ᴀʀᴇ ʏᴏᴜ sᴜʀᴇ ᴛᴏ ᴄᴏɴᴛɪɴᴜᴇ ᴛʜɪs ᴘʀᴏᴄᴇss...?**',
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text="✅️ʏᴇs✅️", callback_data="autofilter_delete"
                    )
                ],
                [
                    InlineKeyboardButton(
                        text="❌️ᴄᴀɴᴄᴇʟ❌️", callback_data="close_data"
                    )
                ],
            ]
        ),
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.message.edit('sᴜᴄᴄᴇsғᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ᴀʟʟ ғɪʟᴇs ғʀᴏᴍ ʏᴏᴜʀ ᴅᴀᴛᴀʙᴀsᴇ.')
...
async def save_template(client, message):
    ...
    if chat_type == "private":
        ...
        if grpid is not None:
            ...
            await message.reply_text("ᴏᴏᴘs! ɪ ᴀᴍ ɴᴏᴛ ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴛᴏ ᴀɴʏ ɢʀᴏᴜᴘ.", quote=True)
            return
