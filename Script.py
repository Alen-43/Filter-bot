class script(object):
    START_TXT = """👋ʜᴇʏ {},
𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 <a href=https://t.me/{}>{}</a>,\n ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴍᴏᴠɪᴇs ғᴏʀ ʏᴏᴜʀ ɢʀᴏᴜᴘ, ᴊᴜsᴛ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ...

ᴘᴏᴡᴇʀᴅ ʙʏ [sᴘᴀᴄᴇ 4 ᴄɪɴᴇᴍᴀs](https://t.me/space4cinemas)"""
    HELP_TXT = """𝙷𝙴𝚈 {}
...
- 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 𝙲𝙻𝙸𝙲𝙺 𝙷𝙴𝚁 👉 :<a href=https://github.com/Alen-43/Filter-bot>𝐏𝐑𝐎𝐅𝐄𝐒𝐒𝐎𝐑-𝐁𝐎𝐓</a>
